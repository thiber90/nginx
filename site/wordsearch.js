...
function loadWordsSync() {
    ...
    request.open('GET', 'frenchWords.txt', false); // false makes the request synchronous
    request.send(null);
...
function getRandomFrenchWords() {
    const wordsArray = loadWordsSync();
...
function populateGrille(){
    words = getRandomFrenchWords();
        var i = 0;
        var nodes = [];
